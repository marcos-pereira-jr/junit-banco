...
public class PainelConsultarFuncionario extends JPanel implements ActionListener {
	...
	public PainelConsultarFuncionario(Autenticavel a) {
		...
		btnSalvarAlteraes.setActionCommand("Salvar altera��es");
		...
		if ("Buscar".equals(e.getActionCommand())) {
			if(this.idFuncionarioTxt.getText().compareTo("")!=0) {
				...
				if (funcionarioEncontrado != null) {
					...
					JOptionPane.showMessageDialog(this, "Funcion�rio n�o encontrado!", "Erro", JOptionPane.WARNING_MESSAGE);
					apagaCampos();
				}
			} else {
				JOptionPane.showMessageDialog(this, "Digite o n�mero do funcion�rio!", "Erro", JOptionPane.WARNING_MESSAGE);
			}
		} else {
			if("Salvar altera��es".equals(e.getActionCommand())) {
				if(verificaCampos(this.nomeTxt.getText(),
					...
					try {
						...
						JOptionPane.showMessageDialog(this, "Funcion�rio n�mero "+funcionarioAlterado.getId()+" alterado com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
